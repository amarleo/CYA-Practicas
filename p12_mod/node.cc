...
void Node::setVectorTime(int hora_inicial, int hora_final) {
  vector_time_.push_back(std::make_pair(hora_inicial, hora_final));
}
...
std::vector<std::pair<int,int>> Node::getVectorTime() {
  return vector_time_;
}
